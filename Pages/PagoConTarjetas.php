...
<div class="content">
    ...
    <section class="bank-nothing">
        <div class="bank-card" style="height: 270px;">
            <p id="nothingInbank">Pedido Registrado</p>
            <p id="nothingInbank2">Al poco tiempo recibirás el link de pago Mercado Pago a tu celular <br> También puede reclamar el link de pago directamente enviando un mensaje al 11 4426-4525</p>
