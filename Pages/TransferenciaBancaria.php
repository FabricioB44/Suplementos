...
<div class="content">
    ...
    <section class="bank-nothing">
        <div class="bank-card" style="height: 340px;">
            ...
            <p id="nothingInbank2">Deposite el total a pagar en nuestra cuenta <br> CBU: 0140107903402751525422 <br> Una vez realizado el depósito envíe el comprobante a nuestro WhatsApp: 11 4426-4525 <br>Total a pagar: $5000.99 </p>
